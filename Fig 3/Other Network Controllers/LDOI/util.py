...
most important for uses purposes is the ability to turn Cupy off for ALL files, see below

'''


import time, os, math, pickle, sys, itertools
...
def pickle_it(data, file, use_timestamp=False, verbose=False):
	if use_timestamp:
		...
		# TODO should use a proper paths library to handle all the edge cases
	if verbose:
